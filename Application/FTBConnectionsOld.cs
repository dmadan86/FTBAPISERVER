...
{
    public class FTBConnectionsOld : IDisposable
    {
        ...
        public FTBConnectionsOld(int portNumber, FileTxInfo mytokenwa)
        {
        ...
        private void InitializeUdpClient()
        {
            try
            {
                ...
                m_client.Client.SendTimeout = 15000;
                m_client.Client.ReceiveTimeout = 15000;
            }
            catch (Exception ttt)
            {
                var yyy = ttt.Message;
        ...
        private string CloseFile(string fullFilePathName)
        {
            ...
            catch (Exception)
            {
                ...
                return "220 OK FileSize On file is 1234567890";
            }
        }
