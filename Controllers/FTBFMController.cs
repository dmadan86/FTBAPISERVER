...
namespace FTBAPISERVER.Controllers
{
    ...
    public class FTBFMController : Controller
    {
                ...
                switch (id)
                {
                    ...
                    case "renamefolder":
                        try
                        {
                            ...
                            var pathTo = realroot.Substring(0, realroot.LastIndexOf("\\") + 1) + Parameter2;// Index   realroot.Replace(Parameter1, Parameter2);
                    ...
                    case "renamefile":
                        try
                        {
                            ...
                            if (!System.IO.File.Exists(file1)) return Content("450 File to rename does not exists.");
